    ...
    <div className="min-h-screen bg-[#f8fafc] flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="md:hidden flex items-center justify-between bg-white shadow px-4 py-3 sticky top-0 z-30">
          <button
            className="text-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-blue-400 p-2"
          ...
          <span className="text-xl font-bold text-[var(--color-primary)]">QuickCourt</span>
          <div className="w-8" />
        </div>
