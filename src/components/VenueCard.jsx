    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex-1 flex flex-col">
        ...
        <div className="mt-auto grid grid-cols-1 gap-2">
          <button onClick={bookNow} className="bg-blue-600 text-white px-3 py-2 rounded hover:bg-blue-700 transition text-sm font-semibold">Book Now</button>
          <button onClick={joinWaitlist} className="bg-gray-100 text-blue-700 px-3 py-2 rounded hover:bg-blue-50 transition text-sm font-semibold">Join Waitlist</button>
        </div>
      </div>
    </div>
  );
